...
def location():
  ...
  with open(logi+'/Desktop/Sponky/SP languaje/data/runs.json', 'r') as f:
    runs = json.load(f)
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_sp4math(self, exec_ctx):
    ...
    Math = file("mathing.js")
    calculator = js2py.run_file("data\\js-scripts\\calculator.js")
