...
class Make:
    def json(project_name, dir):
        code = {
            "Make": str(project_name+'.json'),
            "Built-By": "Sponky Lang",
            "Project": {
                "Name": str(project_name),
                "Placed": str(dir)
            },
            "Author": "none",
            "Created_on": date.today().strftime("%B, %d, %Y") if rand.randint(1, 2) == 2 else "none"
        }
